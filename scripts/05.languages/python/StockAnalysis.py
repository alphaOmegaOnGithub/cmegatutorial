...
#    By looking at data from the stock market, particularly some
#    giant technology stocks and others. Used pandas to get stock information,
#    visualize different aspects of it, and finally looked at a few ways of
#    analyzing the risk of a stock, based on its previous performance history.
