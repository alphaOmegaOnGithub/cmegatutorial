...
apstag.init({pubID:__ezapid,adServer:'googletag',videoAdServer:'DFP',schain:{complete:1,ver:'1.0',nodes:[{asi:schain_domain,sid:sellerid,domain:domain,hp:1}]}});function getAmazonSlotById(id){if(typeof __ezaps==='undefined'){return;}
