...
g(this);a.height(a.contents().find("html").outerHeight())})},100),q=m.debounce(function(){tdbAutoload.log("ajax autoload > scroll location change");tdbAutoload._locationChange()},100);"on"===e&&(k.scroll(b),k.scroll(q),k.resize(n),ezoicSiteSpeed({objOrFunction:k.resize, object:k, function: String(/resize/).substring(1).slice(0,-1)}, String(/documentReady/).substring(1).slice(0,-1), String(/jQuery-document-ready/).substring(1).slice(0,-1), function(){}),ezoicSiteSpeed({objOrFunction:k.scroll, object:k, function: String(/scroll/).substring(1).slice(0,-1)}, String(/documentReady/).substring(1).slice(0,-1), String(/jQuery-document-ready/).substring(1).slice(0,-1), function(){}))}},_fixSmartSidebar:function(){var a=k.scrollTop(),e=a+k.height();g(".tdb-autoload-wrap").find("iframe").each(function(){var b=g(this),l=b.offset().top-g("#wpadminbar").outerHeight(),c=b.outerHeight(!0);b=b.attr("id");l<a&&l+
...
e:d.tdb_global_vars.wpRestUrl+a+"?"+e},_getUniqueID:function(){function a(){return Math.floor(65536*(1+Math.random())).toString(16).substring(1)}return a()+a()+"-"+a()+"-"+a()+"-"+a()+"-"+a()+a()+a()},log:function(a,d){}};ezoicSiteSpeed(p, String(/documentReady/).substring(1).slice(0,-1), String(/jQuery-document-dot-ready/).substring(1).slice(0,-1), function(){tdbAutoload.init()})})(jQuery,this,_);
