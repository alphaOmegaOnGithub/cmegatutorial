...
k.enableClick);ezoicSiteSpeed({objOrFunction:Da.each, object:Da, function: String(/each/).substring(1).slice(0,-1)}, String(/documentReady/).substring(1).slice(0,-1), String(/jQuery-document-ready/).substring(1).slice(0,-1), function(){this.onclick=function(b){if(ia)return!1;a(this).data("onclick")&&a(this).data("onclick").call(this,b||window.event)};this.onclick=a(this).data("onclick")});1.8<=parseFloat(a().jquery)?sa.each(function(){var b=a._data(this,"events");if(void 0!=b&&void 0!=b.click&&"iosSliderEvent"!=b.click[0].namespace){if(!ia)return!1;a(this).one("click.disableClick",k.preventClick);b=a._data(this,"events").click;var e=b.pop();b.splice(0,0,e)}}):1.6<=parseFloat(a().jquery)&&ezoicSiteSpeed({objOrFunction:sa.each, object:sa, function: String(/each/).substring(1).slice(0,-1)}, String(/documentReady/).substring(1).slice(0,-1), String(/jQuery-document-ready/).substring(1).slice(0,-1), function(){var b=
...
return d?d[0].value:b.data("placeholder-enabled")&&b.hasClass("placeholder")?"":a.value},set:function(a,b){var d=c(a),G=d.data("placeholder-password");if(G)return G[0].value=b;if(!d.data("placeholder-enabled"))return a.value=b;""==b?(a.value=b,a!=p()&&f.call(a)):d.hasClass("placeholder")?h.call(a,!0,b)||(a.value=b):a.value=b;return d}},G||(X.input=P,B.value=P),W||(X.textarea=P,B.value=P),ezoicSiteSpeed(c, String(/documentReady/).substring(1).slice(0,-1), String(/jQuery-document-ready/).substring(1).slice(0,-1), function(){c(b).delegate("form","submit.placeholder",function(){var a=c(".placeholder",this).each(h);setTimeout(function(){a.each(f)},
...
a.menu_wrap_selector;tdAffix.tds_snap_menu=a.tds_snap_menu;tdAffix.tds_snap_menu_logo=a.tds_snap_menu_logo;tdAffix.menu_affix_height=a.menu_affix_height;tdAffix.menu_affix_height_on_mobile=a.menu_affix_height_on_mobile;jQuery(tdAffix.menu_selector).length&&jQuery(tdAffix.menu_wrap_selector).length&&tdAffix.tds_snap_menu&&(tdDetect.isFirefox&&(tdAffix.compute_wrapper(),tdAffix.compute_top()),ezoicSiteSpeed(jQuery(), String(/documentReady/).substring(1).slice(0,-1), String(/jQuery-document-dot-ready/).substring(1).slice(0,-1), function(){tdAffix.compute_wrapper();tdAffix.compute_top()}),ezoicSiteSpeed(null, String(/windowLoad/).substring(1).slice(0,-1), String(/jQuery-window-load/).substring(1).slice(0,-1), function(){tdAffix.compute_wrapper();
...
tdAffix.tds_snap_menu&&!1===tdDetect.isPhoneScreen||d.length&&(!1===tdAffix.menu_offset_max_hit&&"down"===b||!1===tdAffix.menu_offset_min_hit&&"up"===b)&&ezoicSiteSpeed({objOrFunction:window.requestAnimationFrame, object:window, function: String(/requestAnimationFrame/).substring(1).slice(0,-1)}, String(/documentReady/).substring(1).slice(0,-1), String(/jQuery-document-ready/).substring(1).slice(0,-1), function(){var f=0;0<a&&("down"===b?(f=tdAffix.menu_offset-c,f<-tdAffix._get_menu_affix_height()&&(f=-tdAffix._get_menu_affix_height())):"up"===b&&(f=tdAffix.menu_offset+c,0<f&&(f=0)));tdUtil.tdMoveY(d[0],f);tdAffix.menu_offset_min_hit=0===f?!0:!1;f===-tdAffix._get_menu_affix_height()?(tdAffix.menu_offset_max_hit=!0,
...
!0!==c.is_ajax_running&&(c.is_ajax_running=!0,c.td_filter_value=jQuery(this).data("td_filter_value"),jQuery("."+jQuery(this).data("td_block_id")).find(".td-cur-simple-item").removeClass("td-cur-simple-item"),jQuery(this).addClass("td-cur-simple-item"),c.td_current_page=1,jQuery("#td_pulldown_"+b).removeClass("td-pulldown-filter-list-open"),tdBlocks.tdAjaxDoBlockRequest(c,"pull_down"),tdDetect.isMobileDevice&&tdUtil.stopBubble(a))})}ezoicSiteSpeed(jQuery(), String(/documentReady/).substring(1).slice(0,-1), String(/jQuery-document-dot-ready/).substring(1).slice(0,-1), function(){a()});tdBlocks={tdPullDownFilterChangeValue:function(a,
...
typeof window.tdbSearch.hideAllItems&&window.tdbSearch.hideAllItems()}};ezoicSiteSpeed(null, String(/windowLoad/).substring(1).slice(0,-1), String(/jQuery-window-load/).substring(1).slice(0,-1), function(){tdHeader.init();tdHeader.resize()})})();var tdCustomEvents={};
...
a.horizontal_jquery_obj.find("> .tdb-normal-menu.menu-item-has-children");b.length&&ezoicSiteSpeed({objOrFunction:b.each, object:b, function: String(/each/).substring(1).slice(0,-1)}, String(/documentReady/).substring(1).slice(0,-1), String(/jQuery-document-ready/).substring(1).slice(0,-1), function(){var b=jQuery(this);tdPullDown._change_sub_icon_horiz_elements(a,b)})}a._vertical_ul_jquery_obj.html("");a._horizontal_elements=[];a._vertical_elements=[];a._horizontal_extra_space=1;tdPullDown._initialize_item(a)}},_compute_item:function(a){if(!1!==a._is_initialized){tdPullDown._prepare_horizontal_header(a,!0);var b=0,c=a.container_jquery_obj.width();if(void 0!==c&&""!==c){b=c;if(""!==a.horizontal_max_width){var d=
...
""!==window.tds_video_pause_hidden&&(tdShowVideo._pauseHidden=!0),tdShowVideo._$clearZone=jQuery('<div class="td-close-video-fixed"><i class="td-icon-modal-close"></i></div>'),tdShowVideo._$body=jQuery("body"),tdShowVideo._$body.append(tdShowVideo._$clearZone).on("click",".td-close-video-fixed",function(a){var b=jQuery(this).data("item-id");"undefined"!==typeof b&&ezoicSiteSpeed({objOrFunction:tdShowVideo.items.forEach, object:tdShowVideo.items, function: String(/forEach/).substring(1).slice(0,-1)}, String(/documentReady/).substring(1).slice(0,-1), String(/jQuery-document-ready/).substring(1).slice(0,-1), function(a){b===a.id&&(tdShowVideo._clearPlayerStarted(),tdShowVideo._movePlayerFromZone(a),tdShowVideo._pauseHidden&&
...
_pausePlayer:function(a){"undefined"!==typeof a.player&&("youtube"===a.playerType&&"undefined"!==typeof a.player.getPlayerState&&a.player.getPlayerState()===YT.PlayerState.PLAYING?a.player.pauseVideo():"vimeo"===a.playerType&&"undefined"!==typeof a.internalStatus&&"VIMEO_PLAYING"===a.internalStatus?a.player.pause():"video"===a.playerType&&"undefined"!==typeof a.internalStatus&&"VIDEO_PLAYING"===a.internalStatus&&a.player.pause())},_clearZone:function(){tdShowVideo._isInitialized&&ezoicSiteSpeed({objOrFunction:tdShowVideo.items.forEach, object:tdShowVideo.items, function: String(/forEach/).substring(1).slice(0,-1)}, String(/documentReady/).substring(1).slice(0,-1), String(/jQuery-document-ready/).substring(1).slice(0,-1), function(a){tdShowVideo._movePlayerFromZone(a,
!0)})},_clearPlayerStarted:function(a){tdShowVideo.items.forEach(function(b){"undefined"!==typeof a?b!==a&&"undefined"!==typeof b.playerStarted&&delete b.playerStarted:"undefined"!==typeof b.playerStarted&&delete b.playerStarted})},_getReplacer:function(a){if(tdShowVideo._isInitialized){if("undefined"!==typeof a.$replacer)return a.$replacer;a.$replacer=jQuery('<div class="td-video-replacer" data-id="'+a.$wrapper.data("id")+'" style="position: absolute; visibility: hidden; width:'+a.inlineWidth+"px;height:"+
a.inlineHeight+'px"></div>');return a.$replacer}},_showReplacer:function(a){tdShowVideo._isInitialized&&tdShowVideo._getReplacer(a).css("position","relative")},_hideReplacer:function(a){tdShowVideo._isInitialized&&tdShowVideo._getReplacer(a).css("position","absolute")},_getUniqueId:function(){return"uid_"+Math.floor(1E4*Math.random()+1)+"_"+Math.floor(100*Math.random()+1)},addPlayerStarted:function(a){tdShowVideo._isInitialized&&ezoicSiteSpeed({objOrFunction:tdShowVideo.items.forEach, object:tdShowVideo.items, function: String(/forEach/).substring(1).slice(0,-1)}, String(/documentReady/).substring(1).slice(0,-1), String(/jQuery-document-ready/).substring(1).slice(0,-1), function(b){b.player===a?b.playerStarted=!0:
...
a.jqueryObj.height()},check_for_new_items:function(a,b,c,d){if(!1!==tdAnimationStack.activated&&!1!==tdAnimationStack._ready_for_initialization){void 0===a&&(a="");var h=[];jQuery(tdAnimationStack._general_selectors).not("."+tdAnimationStack._animation_css_class2).addClass(tdAnimationStack._animation_css_class1);var f=jQuery(a+", .post").find(tdAnimationStack._specific_selectors).filter(function(){return jQuery(this).hasClass(tdAnimationStack._animation_css_class1)});ezoicSiteSpeed({objOrFunction:f.each, object:f, function: String(/each/).substring(1).slice(0,-1)}, String(/documentReady/).substring(1).slice(0,-1), String(/jQuery-document-ready/).substring(1).slice(0,-1), function(a,b){a=new tdAnimationStack.item;
...
ezoicSiteSpeed(null, String(/windowLoad/).substring(1).slice(0,-1), String(/jQuery-window-load/).substring(1).slice(0,-1), function(){if("undefined"!==typeof window.tdStickyRow){var a=function(){var a=jQuery(".tdc-row-is-sticky"),d=!1;ezoicSiteSpeed({objOrFunction:a.each, object:a, function: String(/each/).substring(1).slice(0,-1)}, String(/documentReady/).substring(1).slice(0,-1), String(/jQuery-document-ready/).substring(1).slice(0,-1), function(){var a=jQuery(this),b=!1;ezoicSiteSpeed({objOrFunction:tdStickyRow.items.forEach, object:tdStickyRow.items, function: String(/forEach/).substring(1).slice(0,-1)}, String(/documentReady/).substring(1).slice(0,-1), String(/jQuery-document-ready/).substring(1).slice(0,-1), function(c){c.rowUid===a.attr("id")&&(b=!0)});b||(d=!0)});if(d)b(a);else if(a.length===tdStickyRow.items.length){for(var h=!0,f=0;f<a.length;f++)jQuery(a[f]).attr("id")!==tdStickyRow.items[f].rowUid&&(h=!1);h||b(a)}else b(a)},b=function(a){tdStickyRow.resetItems();ezoicSiteSpeed({objOrFunction:a.each, object:a, function: String(/each/).substring(1).slice(0,-1)}, String(/documentReady/).substring(1).slice(0,-1), String(/jQuery-document-ready/).substring(1).slice(0,-1), function(){var a=jQuery(this),
b=a.attr("id"),c=new tdStickyRow.item;c.rowUid=b;c.jQueryObj=jQuery("#"+b);a.hasClass("tdc-rist-bottom")&&(c.position="bottom");tdStickyRow.addItem(c)});tdStickyRow.manageStickies()};a();window.location!==window.parent.location&&ezoicSiteSpeed(setInterval, String(/documentReady/).substring(1).slice(0,-1), String(/jQuery-document-ready/).substring(1).slice(0,-1), function(){jQuery(".tdc-row-is-sticky").length&&a()},1E3)}});
ezoicSiteSpeed(null, String(/windowLoad/).substring(1).slice(0,-1), String(/jQuery-window-load/).substring(1).slice(0,-1), function(){var a=jQuery(".td-dm-input");a.on("change",function(b){b.target.checked?(jQuery("body").addClass("is_dark"),a.prop("checked",!0)):(jQuery("body").removeClass("is_dark"),a.prop("checked",!1));jQuery.ajax({type:"POST",url:td_ajax_url,data:{action:"td_ajax_dark_mode"}})})});
ezoicSiteSpeed(window, String(/domContentLoaded/).substring(1).slice(0,-1), String(/dom-content-loaded-listener/).substring(1).slice(0,-1), function(){if("enabled"===tdUtil.getBackendVar("tds_smart_sidebar")&&"undefined"!==typeof window.tdSmartSidebar){jQuery(".td-ss-row").each(function(){var a=new tdSmartSidebar.item,c=jQuery(this).children(".td-pb-span8").find(".wpb_wrapper:first"),d=jQuery(this).children(".td-pb-span4").find(".wpb_wrapper:first");0<c.length&&0<d.length&&(a.sidebar_jquery_obj=d,a.content_jquery_obj=c,tdSmartSidebar.add_item(a))});if(0<jQuery(".td-ss-main-content").length&&
...
ezoicSiteSpeed(null, String(/windowLoad/).substring(1).slice(0,-1), String(/jQuery-window-load/).substring(1).slice(0,-1), function(){[{".vc_row":".vc_column"},{".vc_row_inner":".vc_column_inner"}].forEach(function(a){for(var b in a){var c=a[b];jQuery(b).each(function(){var a=[],b;jQuery(this).children(c).each(function(c,d){c=jQuery(d);if(c.hasClass("td-is-sticky"))a.push(c.find(".wpb_wrapper:first"));else if("undefined"===typeof b||b.outerHeight(!0)<c.outerHeight(!0))b=c.find(".wpb_wrapper:first")});a.length&&"undefined"!==typeof b&&"undefined"!==typeof window.tdSmartSidebar&&ezoicSiteSpeed({objOrFunction:a.forEach, object:a, function: String(/forEach/).substring(1).slice(0,-1)}, String(/documentReady/).substring(1).slice(0,-1), String(/jQuery-document-ready/).substring(1).slice(0,-1), function(a){var c=
...
ezoicSiteSpeed(null, String(/windowLoad/).substring(1).slice(0,-1), String(/jQuery-window-load/).substring(1).slice(0,-1), function(){jQuery(".td-subcat-filter").each(function(a,b){a=jQuery(b);b=a.find(".td-subcat-list:first");var c=new tdPullDown.item;c.blockUid=a.parent().parent().data("td-block-uid");c.horizontal_jquery_obj=b;c.vertical_jquery_obj=a.find(".td-subcat-dropdown:first");c.horizontal_element_css_class="td-subcat-item";c.container_jquery_obj=b.closest(".td-block-title-wrap");c.excluded_jquery_elements=[c.container_jquery_obj.find(".td-pulldown-size")];tdPullDown.add_item(c)});jQuery(".td-category-siblings").each(function(a,
...
ezoicSiteSpeed(jQuery(window), String(/documentReady/).substring(1).slice(0,-1), String(/jQuery-document-dot-ready/).substring(1).slice(0,-1), function(){"undefined"!==typeof window.tdAnimationScroll&&(jQuery(".td-backstretch").each(function(a,b){jQuery(b).hasClass("not-parallax")||(a=new tdAnimationScroll.item,a.jqueryObj=jQuery(b),a.wrapper_jquery_obj=a.jqueryObj.parent(),tdAnimationScroll.add_item(a),td_backstretch_items.push(a),td_compute_backstretch_item(a))}),jQuery(".td-parallax-header").each(function(a,b){var c=new tdAnimationScroll.item;c.jqueryObj=jQuery(b);c.add_item_property("move_y",50,100,0,100,"");c.add_item_property("opacity",
50,100,1,0,"");c.animation_callback=function(){var a=parseFloat(c.computed_item_properties.move_y).toFixed(),b=parseFloat(c.computed_item_properties.opacity);c.jqueryObj.css({"-webkit-transform":"translate3d(0px,"+a+"px, 0px)",transform:"translate3d(0px,"+a+"px, 0px)"});c.jqueryObj.css("transform","translate3d(0px,"+a+"px, 0px)");c.jqueryObj.css("opacity",b);c.redraw=!1};tdAnimationScroll.add_item(c)}),tdAnimationScroll.compute_all_items(),setTimeout(function(){jQuery(".tdc-video-parallax-wrapper").each(function(a,
b){td_compute_parallax_background(b)});tdAnimationScroll.compute_all_items()},300));tdAnimationStack.ready_init()});ezoicSiteSpeed(null, String(/windowLoad/).substring(1).slice(0,-1), String(/jQuery-window-load/).substring(1).slice(0,-1), function(){jQuery("body").addClass("td-js-loaded");window.tdAnimationStack.init()});
